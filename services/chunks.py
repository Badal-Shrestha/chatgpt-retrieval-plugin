...
MIN_CHUNK_SIZE_CHARS = 600  # The minimum size of each text chunk in characters
MIN_CHUNK_LENGTH_TO_EMBED = 10  # Discard chunks shorter than this
EMBEDDINGS_BATCH_SIZE = int(
    os.environ.get("OPENAI_EMBEDDING_BATCH_SIZE", 256)
)  # The number of embeddings to request at a time
MAX_NUM_CHUNKS = 5000  # The maximum number of chunks to generate from a text
